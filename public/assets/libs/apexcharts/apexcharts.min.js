    ...
    var g = function () {
        ...
        return a(t, [{
            ...
            key: "addDarkenFilter", value: function (t, e, i) {
                ...
                if (!g.isFirefox()) {
                    ...
                    n.size("120%", "180%", "-5%", "-40%"), t.filter((function (t) {
                        var i = s.config.chart.dropShadow;
                        (n = i.enabled ? a.addShadow(t, e, i) : t).componentTransfer({rgb: {type: "linear", slope: r}})
                    })), t.filterer.node.setAttribute("filterUnits", "userSpaceOnUse")
                }
            }
        }, {
        ...
        return a(t, [{
            ...
            key: "renderPaths", value: function (t) {
                ...
                var T = A.config.stroke.dashArray, E = 0;
                ...
                if (M.attr("index", a), m && M.attr({"clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")")}), "none" !== A.config.states.normal.filter.type) S.getDefaultFilter(M, a); else if (A.config.chart.dropShadow.enabled && k && (!A.config.chart.dropShadow.enabledSeries || A.config.chart.dropShadow.enabledSeries && -1 !== A.config.chart.dropShadow.enabledSeries.indexOf(a))) {
                ...
                var X = {el: M, j: i, realIndex: a, pathFrom: s, pathTo: r, fill: c, strokeWidth: l};
                return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || C.showDelayedElements() : C.animatePathsGradually(n({}, X, {
                    speed: g,
                    delay: d
                })), A.globals.dataChanged && P && z && C.animatePathsGradually(n({}, X, {speed: p})), M
            }
        }, {
        ...
        return a(t, [{
            key: "addPointAnnotation", value: function (t, e, i) {
                ...
                if (!(s < 0 || s > a.globals.gridWidth)) {
                    ...
                    var d = t.label.text ? t.label.text : "", g = this.annoCtx.graphics.drawText({
                        x: s + t.label.offsetX,
                        y: r + t.label.offsetY,
                        text: d,
                        textAnchor: t.label.textAnchor,
                    ...
                    if (g.attr({rel: i}), e.appendChild(g.node), t.customSVG.SVG) {
                        var u = this.annoCtx.graphics.group({class: "apexcharts-point-annotations-custom-svg " + t.customSVG.cssClass});
                        u.attr({transform: "translate(".concat(s + t.customSVG.offsetX, ", ").concat(r + t.customSVG.offsetY, ")")}), u.node.innerHTML = t.customSVG.SVG, e.appendChild(u.node)
                    }
                }
            }
        }, {
    ...
    var y, w, k = {
        ...
        return a(t, [{
            ...
            key: "addText", value: function (t, e, i) {
                var a = t.x, s = t.y, r = t.text, n = t.textAnchor, o = t.appendTo,
                    ...
                    C = void 0 === S ? 2 : S, L = i, P = L.w, z = P.globals.dom.baseEl.querySelector(l),
        ...
        return a(t, [{
            ...
            key: "fillPath", value: function (t) {
                ...
                "function" == typeof n && (n = n({seriesIndex: this.seriesIndex, value: t.value, w: e}));
        ...
        return a(t, [{
            ...
            key: "drawPoint", value: function (t, e, i, a, s, r, n) {
                var o = this.w, l = s, h = new f(this.ctx), c = new u(this.ctx), d = new M(this.ctx),
                    g = new I(this.ctx), x = new p(this.ctx), b = g.getMarkerConfig("apexcharts-marker", l),
                    m = d.fillPath({seriesNumber: s, patternUnits: "objectBoundingBox", value: o.globals.series[s][n]}),
                    v = x.drawCircle(i);
            ...
            key: "drawDataLabel", value: function (t, e, i) {
                ...
                for (var g = 0; g < t.x.length; g++) if (l = t.x[g] + o.offsetX, h = t.y[g] + o.offsetY + s, !isNaN(l)) {
                    ...
                    if ("bubble" === r.config.chart.type) {
                        ...
                        var b = new X(this.ctx), m = b.centerTextInBubble(h, e, c);
                        h = m.y
                    } else void 0 !== u && (f = x(u));
        ...
        return a(t, [{
            ...
            key: "highlightRangeInSeries", value: function (t, e) {
                var i = this.w, a = i.globals.dom.baseEl.querySelectorAll(".apexcharts-heatmap-rect"), s = function () {
            ...
            key: "getPreviousPaths", value: function () {
                ...
                if (g.length > 0) for (var u = 0; u < g.length; u++) {
                    for (var f = t.globals.dom.baseEl.querySelectorAll(".apexcharts-bubble-series .apexcharts-series[data\\:realIndex='".concat(u, "'] circle")), p = [], x = 0; x < f.length; x++) p.push({
        ...
        return a(t, [{
            ...
            key: "isFormatXY", value: function () {
                var t = this.w.config.series.slice(), e = new R(this.ctx);
        ...
        return a(t, [{
            ...
            key: "setYRange", value: function () {
                ...
                if (t.minY = r.minY, t.maxY = r.maxY, i = r.lowestY, e.chart.stacked) {
                    var n = [], o = [];
                    if (t.series.length) for (var l = 0; l < t.series[t.maxValsInArrayIndex].length; l++) for (var h = 0, c = 0, d = 0; d < t.series.length; d++) null !== t.series[d][l] && g.isNumber(t.series[d][l]) && (t.series[d][l] > 0 ? h = h + parseFloat(t.series[d][l]) + 1e-4 : c += parseFloat(t.series[d][l])), d === t.series.length - 1 && (n.push(h), o.push(c));
                    for (var u = 0; u < n.length; u++) t.maxY = Math.max(t.maxY, n[u]), t.minY = Math.min(t.minY, o[u])
                }
            ...
            key: "setXRange", value: function () {
                ...
                if (t.isXNumeric) for (var a = 0; a < t.series.length; a++) if (t.labels[a]) for (var s = 0; s < t.labels[a].length; s++) null !== t.labels[a][s] && g.isNumber(t.labels[a][s]) && (t.maxX = Math.max(t.maxX, t.labels[a][s]), t.initialMaxX = Math.max(t.maxX, t.labels[a][s]), t.minX = Math.min(t.minX, t.labels[a][s]), t.initialMinX = Math.min(t.minX, t.labels[a][s]));
                if (t.noLabelsProvided && 0 === e.xaxis.categories.length && (t.maxX = t.labels[t.labels.length - 1], t.initialMaxX = t.labels[t.labels.length - 1], t.minX = 1, t.initialMinX = 1), t.isXNumeric || t.noLabelsProvided || t.dataFormatXNumeric) {
                    var r;
                    if (void 0 === e.xaxis.tickAmount ? (r = Math.round(t.svgWidth / 150), "numeric" === e.xaxis.type && t.dataPoints < 30 && (r = t.dataPoints - 1), r > t.dataPoints && 0 !== t.dataPoints && (r = t.dataPoints - 1)) : "dataPoints" === e.xaxis.tickAmount ? (t.series.length > 1 && (r = t.series[t.maxValsInArrayIndex].length - 1), t.isXNumeric && (r = t.maxX - t.minX - 1)) : r = e.xaxis.tickAmount, t.xTickAmount = r, void 0 !== e.xaxis.max && "number" == typeof e.xaxis.max && (t.maxX = e.xaxis.max), void 0 !== e.xaxis.min && "number" == typeof e.xaxis.min && (t.minX = e.xaxis.min), void 0 !== e.xaxis.range && (t.minX = t.maxX - e.xaxis.range), t.minX !== Number.MAX_VALUE && t.maxX !== -Number.MAX_VALUE) if (e.xaxis.convertedCatToNumeric) {
                        for (var n = [], o = t.minX - 1; o < t.maxX; o++) n.push(o + 1);
                        t.xAxisScale = {result: n, niceMin: n[0], niceMax: n[n.length - 1]}
                    } else t.xAxisScale = this.scales.setXScale(t.minX, t.maxX); else t.xAxisScale = this.scales.linearScale(1, r, r), t.noLabelsProvided && t.labels.length > 0 && (t.xAxisScale = this.scales.linearScale(1, t.labels.length, r - 1), t.seriesX = t.labels.slice());
                    i && (t.labels = t.xAxisScale.result.slice())
                }
                if (t.minX === t.maxX) {
                    var l = new C(this.ctx);
                    if ("datetime" === e.xaxis.type) {
                        var h = e.xaxis.labels.datetimeUTC, c = l.getDate(t.minX);
            ...
            key: "checkResponsiveConfig", value: function (t) {
                ...
                if (0 !== a.responsive.length) {
                    ...
                    var r = new P({}), n = function () {
                        ...
                        } else for (var l = 0; l < s.length; l++) n < s[l].breakpoint && (t = E.extendArrayProps(r, s[l].options), t = g.extend(i.config, t), e.overrideResponsiveOptions(t))
                    };
                    if (t) {
        ...
        return a(t, [{
            ...
            key: "setDimensionsForNonAxisCharts", value: function () {
                ...
                var s = "pie" === i.chart.type || "donut" === i.chart.type ? "pie" : "radialBar",
                    r = 10 + i.plotOptions[s].offsetY, n = i.plotOptions[s].offsetX;
        ...
        return a(t, [{
            key: "draw", value: function (t) {
                ...
                if (this.sliceLabels.forEach((function (t) {
                    k.add(t)
                })), o.attr({transform: "translate(".concat(v, ", ").concat(y - 5, ") scale(").concat(x, ")")}), a.attr({
            ...
            key: "drawArcs", value: function (t, e) {
                var i = this.w, a = new u(this.ctx), s = new p(this.ctx), r = new M(this.ctx),
                ...
                for (var d = 0; d < t.length; d++) {
                    ...
                    if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (0 === (k = (h - o) / this.fullAngle * i.config.chart.animations.speed) && (k = 1), this.animDur = k + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(v, {
                        ...
                        if (0 !== x && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                            ...
                            var P = i.globals.dataLabels.style.colors[d], z = s.drawText({
                                x: A,
                                y: S,
                                text: C,
                                textAnchor: "middle",
        ...
        return a(t, [{
            key: "createToolbar", value: function () {
                ...
                for (var n = [{name: "exportSVG", title: this.localeValues.exportToSVG}, {
                    name: "exportPNG",
                    title: this.localeValues.exportToPNG
                }, {
                    name: "exportCSV",
                    title: this.localeValues.exportToCSV
                }], o = 0; o < n.length; o++) this.elMenuItems.push(document.createElement("div")), this.elMenuItems[o].innerHTML = n[o].title, p.setAttrs(this.elMenuItems[o], {
            ...
            key: "downloadCSV", value: function () {
                var t = this.w;
                new O(this.ctx).exportToCSV({series: t.config.series})
            }
        }, {
        ...
        return a(t, [{
            key: "getNearestValues", value: function (t) {
                var e = t.hoverArea, i = t.elGrid, a = t.clientX, s = t.clientY, r = t.hasBars, n = this.w,
                    o = n.globals.gridWidth, l = o / (n.globals.dataPoints - 1), h = i.getBoundingClientRect();
                (r && n.globals.comboCharts || r) && (l = o / n.globals.dataPoints);
                var c = a - h.left, d = s - h.top;
                ...
                for (var f, p = null, x = null, b = [], m = 0; m < n.globals.seriesXvalues.length; m++) b.push([n.globals.seriesXvalues[m][0] - 1e-6].concat(n.globals.seriesXvalues[m]));
        ...
        return a(t, [{
            ...
            key: "DOMHandling", value: function (t) {
                var e = t.i, i = t.t, a = t.ttItems, s = t.values, r = t.seriesName, n = t.shared, o = t.pColor,
                    l = this.w, h = this.ttCtx, c = s.val, d = s.xVal, g = s.xAxisTTVal, u = s.zVal, f = null;
        ...
        return a(t, [{
            ...
            key: "axisChartsTooltips", value: function (t) {
                ...
                if (this.clientY = c, this.clientX = h, n.globals.capturedSeriesIndex = -1, n.globals.capturedDataPointIndex = -1, c < l.top || c > l.top + l.height) this.handleMouseOut(r); else {
                    ...
                    var g = this.getElTooltip(), u = this.getElXCrosshairs(),
        ...
        return a(t, [{
            ...
            key: "getPathFillColor", value: function (t, e, i, a) {
                var s = this.w, r = new M(this.barCtx.ctx), n = null, o = this.barCtx.barOptions.distributed ? i : e;
        ...
        return a(t, [{
            key: "draw", value: function (t, e) {
                var i = this.w, a = new p(this.ctx), s = new E(this.ctx, i);
                ...
                for (var o = 0, l = 0; o < t.length; o++, l++) {
                    ...
                    for (var S = a.group({class: "apexcharts-datalabels"}), C = 0; C < i.globals.dataPoints; C++) {
                        var L = this.barHelpers.getStrokeWidth(o, C, v), P = null,
                            z = {indexes: {i: o, j: C, realIndex: v, bc: l}, x: f, y: x, strokeWidth: L, elSeries: y};
        ...
        return o(i, t), a(i, [{
            key: "draw", value: function (t, e) {
                var i = this.w, a = new p(this.ctx), s = new M(this.ctx);
                ...
                for (var n = a.group({class: "apexcharts-candlestick-series apexcharts-plot-series"}), o = 0; o < t.length; o++) {
                    ...
                    for (var w = a.group({class: "apexcharts-datalabels"}), k = 0; k < i.globals.dataPoints; k++) {
                        ...
                        var L = s.fillPath({seriesNumber: x, color: A, value: t[o][k]}),
        ...
        return a(t, [{
            key: "draw", value: function (t) {
                var e = this, i = this.w, a = new M(this.ctx), s = [], r = new Y(this.ctx);
                ...
                if (this.yaxisLabels = this.graphics.group({class: "apexcharts-yaxis"}), t.forEach((function (t, o) {
                    ...
                    for (var b = 0; b < h.linePathsTo.length; b++) {
                        ...
                        l.add(m);
                        var v = a.fillPath({seriesNumber: o}), y = e.graphics.renderPaths(n({}, p, {
                        ...
                        if (i.config.chart.dropShadow.enabled) {
                            var w = new u(e.ctx), k = i.config.chart.dropShadow;
        ...
        return o(i, t), a(i, [{
            ...
            key: "drawTracks", value: function (t) {
                var e = this.w, i = new p(this.ctx), a = i.group({class: "apexcharts-tracks"}), s = new u(this.ctx),
                    r = new M(this.ctx), n = this.getStrokeWidth(t);
                t.size = t.size - n / 2;
            ...
            key: "drawArcs", value: function (t) {
                var e = this.w, i = new p(this.ctx), a = new M(this.ctx), s = new u(this.ctx), r = i.group(),
            ...
            key: "drawHollowImage", value: function (t, e, i, a) {
                var s = this.w, r = new M(this.ctx), n = g.randomId(), o = s.config.plotOptions.radialBar.hollow.image;
            ...
            key: "draw", value: function (t, e) {
                ...
                for (var s = a.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), r = 0; r < t.length; r++) {
                    ...
                    for (var y = a.group({class: "apexcharts-datalabels"}), w = 0; w < i.globals.dataPoints; w++) {
                        ...
                        d = C.y, c = C.x;
                        var E = this.barHelpers.getPathFillColor(t, r, w, f), M = i.globals.stroke.colors[f];
                        this.renderSeries({
                            realIndex: f,
                            pathFill: E,
                            lineFill: M,
        ...
        return a(t, [{
            ...
            key: "resizeNonAxisCharts", value: function () {
                ...
                if (a) {
                    ...
                    if (r = n.bottom, s) {
                        var o = g.getBoundingClientRect(s), l = Math.max(n.bottom, o.bottom) - n.top + o.height;
                        r = Math.max(2 * t.globals.radialSize, l)
                    }
                }
                var h = r + e.translateY + i + 20;
                e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", h), e.dom.elWrap.style.height = h + "px", p.setAttrs(e.dom.Paper.node, {height: h}), e.dom.Paper.node.parentNode.parentNode.style.minHeight = h + "px"
            }
        }, {
        ...
        return a(i, [{
            key: "_updateOptions", value: function (e) {
                var i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    ...
                    r = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], n = [this.ctx];
                ...
                case"A":
                    t = (e = function (t, e) {
                        var i, a, s, r, n, o, l, h, c, d, g, u, f, p, x, b, m, v, y, w, k, A, S, C, L, P,
                            z = Math.abs(e[1]), T = Math.abs(e[2]), E = e[3] % 360, M = e[4], I = e[5], X = e[6],
                            Y = e[7], R = new SVG.Point(t), F = new SVG.Point(X, Y), D = [];
                        ...
                        for (b[0][0] = b[0][1].clone(), b[b.length - 1][2] = b[b.length - 1][1].clone(), s = (new SVG.Matrix).rotate(E).scale(z, T).rotate(-E), k = 0, A = b.length; k < A; k++) b[k][0] = b[k][0].transform(s), b[k][1] = b[k][1].transform(s), b[k][2] = b[k][2].transform(s);
