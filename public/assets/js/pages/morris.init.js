$(function () {
    ...
    $("#morris-line-example").length && Morris.Line({
        ...
        data: [{y: "2010", a: 110, b: 125}, {y: "2011", a: 170, b: 190}, {y: "2012", a: 120, b: 140}, {
            y: "2013",
            a: 80,
            b: 100
        }, {y: "2014", a: 110, b: 130}, {y: "2015", a: 90, b: 110}, {y: "2016", a: 120, b: 140}, {
            y: "2017",
            a: 110,
            b: 125
        }, {y: "2018", a: 170, b: 190}, {y: "2019", a: 120, b: 140}]
        ...
        data: [{label: "Samsung Mobiles", value: 12}, {label: "Apple Mobiles", value: 30}, {
            label: "Vivo Mobiles",
            value: 20
        }]
    }), $("#morris-stacked-example").length && Morris.Bar({
        ...
        stacked: !0,
        labels: ["Series A", "Series B"]
    }), $("#morris-line-straight-example").length && Morris.Line({
