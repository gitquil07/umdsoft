...
class Block9 extends React.Component {
    render() {
        return(
            <div className={`${st.section} d-flex flex-wrap align-items-center justify-content-between`}> 
                <div style={{width: '48%'}} className={`${st.progres} ${st.w1}`}> 
                    <h2 className={st.block__h2}>После прохождения курса вы получите электронный сертификат *</h2>
