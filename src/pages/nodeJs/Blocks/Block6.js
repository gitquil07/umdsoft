    ...
    render() {
        return(
            <div className={`d-flex justify-content-between flex-wrap ${st.section}`}>  
                ...
                <p className={`${st.w1} ${st.block__p}`} style={{width: '46%'}}>
                ...
                <span className={st.w1} style={{width: '45%'}}>
                    <i className="fas fa-exclamation-circle text-success"></i>
                ...
                <div className={`d-flex flex-wrap justify-content-between align-items-center mb-4 ${st.w1}`}>
                    ...
                    />
                    <div className={st.w1} style={{width: '44%', marginRight: '12px'}}>
